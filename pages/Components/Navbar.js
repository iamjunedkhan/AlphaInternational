  ...
  return (
    <>
      ...
      <div className={`flex flex-col justify-center overflow-hidden transition-all duration-300  ${showNavbar?'h-[250px]':'h-0'}`}>
        <span className={`px-3 mx-4 my-2 text-xl hover:scale-105  hover:font-semibold cursor-pointer transition-all duration-150 relative ${currentPage==''?'font-semibold bg-red-800 rounded-md text-white ':'hover:text-red-800 hover:underline underline-offset-4'}  `}><Link href="/" >Home</Link></span>
        <span className={`px-3 mx-4 my-2 text-xl hover:scale-105  hover:font-semibold cursor-pointer transition-all duration-150 relative ${currentPage=='about'?'font-semibold bg-red-800 rounded-md text-white ':'hover:text-red-800 hover:underline underline-offset-4'}  `}><Link href="/about" >About</Link></span>
        <span className={`px-3 mx-4 my-2 text-xl hover:scale-105  hover:font-semibold cursor-pointer transition-all duration-150 relative ${currentPage=='admission'?'font-semibold bg-red-800 rounded-md text-white ':'hover:text-red-800 hover:underline underline-offset-4'}  `}><Link href="/admission" >Admission</Link></span>
        <span className={`px-3 mx-4 my-2 text-xl hover:scale-105  hover:font-semibold cursor-pointer transition-all duration-150 relative ${currentPage=='parents'?'font-semibold bg-red-800 rounded-md text-white ':'hover:text-red-800 hover:underline underline-offset-4'}  `}><Link href="/parents" >Parents</Link></span>
        {/* <span className={`px-3 mx-4 my-2 text-xl hover:scale-105  hover:font-semibold cursor-pointer transition-all duration-150 relative ${currentPage=='more'?'font-semibold bg-red-800 rounded-md text-white ':'hover:text-red-800 hover:underline underline-offset-4'}  `}><Link href="/" >More</Link></span> */}
      </div>
    </>
  )
}
